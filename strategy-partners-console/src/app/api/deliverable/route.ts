...
import { buildIcMemoDocx, buildPitchDeckPptx, buildModelXlsx, type DeliverableData } from '@/lib/server/deliverables'

export const runtime = 'nodejs'
export const dynamic = 'force-dynamic'

// Gera o entregável da boutique (IC memo / deck / modelo) a partir dos dados da análise.
  ...
  try {
    ...
    return new Response(new Uint8Array(buffer), {
      ...
      headers: {
        ...
        'Content-Disposition': `attachment; filename="StrategyPartners_${safeName}.${ext}"`,
      },
    })
  } catch (err) {
