...
const PROJECTS = [
  {
    ...
    agents: ['Estrategista', 'Analista', 'Jurista'],
  ...
  },
  {
    ...
    agents: ['Tesouro', 'Contábil', 'Estrategista'],
  ...
  },
  {
    ...
    agents: ['Pesquisador', 'Redator', 'Estrategista'],
